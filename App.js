class App {
    ...
    static emitEventToPlayer(e) {
		...
		App.iframe1[0].contentWindow.postMessage(e, "*");
		App.iframe2[0].contentWindow.postMessage(e, "*");
		App.iframe3[0].contentWindow.postMessage(e, "*");
		App.iframe4[0].contentWindow.postMessage(e, "*");
    ...
    static openURL(url) {
		...
		App.iframe1.attr('src', url);
		App.iframe2.attr('src', url);
		App.iframe3.attr('src', url);
		App.iframe4.attr('src', url);
    }
	...
	static get iframe1() {
        return $("#embedded-player1");
    }
	
	static get iframe2() {
        return $("#embedded-player2");
    }
	
	static get iframe3() {
        return $("#embedded-player3");
    }
	
	static get iframe4() {
        return $("#embedded-player4");
    }
